...
train_pipeline = [
    ...
    dict(type='RandomRotate', prob=0.5, angle_range=180, rect_obj_labels=None),
    dict(type='mmdet.Pad', size=img_size, pad_val=dict(img=pad_val)),
...
optim_wrapper = dict(
    type='AmpOptimWrapper', optimizer=dict(lr=0.001 / 8))  # TODO:
val_evaluator = dict(
    metric='f1_score',
    iou_thrs=0.1,
    merge_patches=True,
