...
model = dict(
    ...
    test_cfg=dict(
        ...
        max_per_img=1000)) # TODO: ori: 2000
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        filter_cfg=dict(filter_empty_gt=False), # TODO:
        data_root=data_root,
...
train_cfg = dict(val_interval=36) # TODO:
custom_hooks = _base_.custom_hooks
custom_hooks.append(dict(type='RecorderOutputHook'))

optim_wrapper = dict(optimizer=dict(lr=0.001 / 8)) # TODO:
